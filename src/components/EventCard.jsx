  ...
  return (
    ...
    >
      ...
      {deleteModal && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-sm w-full text-center">
            <h2 className="text-xl font-bold mb-4 text-red-700">تأكيد حذف الفعالية</h2>
            <p className="mb-6 text-gray-700">هل أنت متأكد أنك تريد حذف هذه الفعالية؟</p>
            <button
              className="bg-red-600 text-white px-6 py-2 rounded-lg font-semibold mx-2"
